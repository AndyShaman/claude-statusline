Форкнул Ваш проект [claude-statusline](https://github.com/AndyShaman/claude-statusline) и обнаружил несколько проблем. Большинство из них детерминированные - воспроизводятся на любой установке на Linux или Windows в силу особенностей среды или изначально неверной логики в коде. Хочу сделать PR - заранее описываю, что там будет:
